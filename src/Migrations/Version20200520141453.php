 ...
 */
final class Version20200520141453 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE opinion (id INT AUTO_INCREMENT NOT NULL, game_id INT NOT NULL, user_id INT NOT NULL, title VARCHAR(30) NOT NULL, content LONGTEXT NOT NULL, note DOUBLE PRECISION NOT NULL, posted_on DATETIME NOT NULL, INDEX IDX_AB02B027E48FD905 (game_id), INDEX IDX_AB02B027A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
