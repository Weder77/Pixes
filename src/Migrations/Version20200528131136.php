 ...
 */
final class Version20200528131136 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE profile (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, firstname VARCHAR(50) DEFAULT NULL, lastname VARCHAR(50) DEFAULT NULL, birthday DATE DEFAULT NULL, balance DOUBLE PRECISION DEFAULT NULL, register_date DATETIME NOT NULL, picture VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8157AA0FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE code (id INT AUTO_INCREMENT NOT NULL, game_id INT NOT NULL, invoice_id INT DEFAULT NULL, code VARCHAR(30) NOT NULL, used TINYINT(1) NOT NULL, INDEX IDX_77153098E48FD905 (game_id), INDEX IDX_771530982989F1FD (invoice_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE invoice (id INT AUTO_INCREMENT NOT NULL, profile_id INT NOT NULL, purchase_date DATE NOT NULL, INDEX IDX_90651744CCFA12B8 (profile_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE code ADD CONSTRAINT FK_771530982989F1FD FOREIGN KEY (invoice_id) REFERENCES invoice (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE code DROP FOREIGN KEY FK_771530982989F1FD');
